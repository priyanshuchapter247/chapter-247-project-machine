...
var whitelistedFields = ['firstName', 'lastName', 'email', 'username', 'phone', 'address.place', 'address.city', 'address.state', 'address.zipcode', 'address.country', 'designation', 'skills'];
