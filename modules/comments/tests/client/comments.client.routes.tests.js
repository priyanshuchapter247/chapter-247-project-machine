  ...
  describe('Comments Route Tests', function () {
    ...
    describe('Route Config', function () {
      ...
      describe('Create Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          createstate = $state.get('comments.create');
          $templateCache.put('modules/comments/client/views/form-comment.client.view.html', '');
        ...
        it('should respond to URL', inject(function ($state) {
          expect($state.href(createstate)).toEqual('/comments/create');
        }));
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('modules/comments/client/views/form-comment.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          editstate = $state.get('comments.edit');
          $templateCache.put('modules/comments/client/views/form-comment.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('modules/comments/client/views/form-comment.client.view.html');
        });
